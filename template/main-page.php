            ...
            <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
                ...
                <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                        <img src="static/images/kvartiri/Kronstadskii-kv1.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>ЖК Кранштадский</h4>
                            <p>бюджет 1.1 млн</p>
                            <a href="static/images/kvartiri/Kronstadskii-kv1.jpg" title="App 1" data-gallery="portfolio-gallery-app"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                        <img src="static/images/kvartiri/Kronstadskii-kv2.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>ЖК Кранштадский</h4>
                            <p>бюджет 1.1 млн</p>
                            <a href="static/images/kvartiri/Kronstadskii-kv2.jpg" title="Product 1" data-gallery="portfolio-gallery-product"
                               class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                            <a href="mitino1-details.html" title="More Details" class="details-link"><i
                                    class="bi bi-link-45deg"></i></a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                        <img src="static/images/kvartiri/Kronstadskii-kv3.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>ЖК Кранштадский</h4>
                            <p>бюджет 1.1 тыс</p>
                            <a href="static/images/kvartiri/Kronstadskii-kv3.jpg" title="Branding 1" data-gallery="portfolio-gallery-branding"
                               class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                            <a href="mitino1-details.html" title="More Details" class="details-link"><i
                                    class="bi bi-link-45deg"></i></a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                        <img src="static/images/kvartiri/Kronstadskii-kv4.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>ЖК Кранштадский</h4>
                            <p>бюджет 1.1 млн</p>
                            <a href="static/images/kvartiri/Kronstadskii-kv4.jpg" title="App 2" data-gallery="portfolio-gallery-app"
                               class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                            <a href="mitino1-details.html" title="More Details" class="details-link"><i
                                    class="bi bi-link-45deg"></i></a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                        <img src="static/images/kvartiri/Mitinskii-les/1-spalnia.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>ЖК Митинский лес</h4>
                            <p>бюджет 988.000₽</p>
                            <a href="static/images/kvartiri/Mitinskii-les/1-spalnia.jpg" title="Product 2" data-gallery="portfolio-gallery-product"
                               class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                            <a href="mitino1-details.html" title="More Details" class="details-link"><i
                                    class="bi bi-link-45deg"></i></a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                        <img src="static/images/kvartiri/Mitinskii-les/3-zal.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>ЖК Митинский лес</h4>
                            <p>бюджет 988.000₽</p>
                            <a href="static/images/kvartiri/Mitinskii-les/3-zal.jpg" title="Branding 2" data-gallery="portfolio-gallery-branding"
                               class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                            <a href="mitino1-details.html" title="More Details" class="details-link"><i
                                    class="bi bi-link-45deg"></i></a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                        <img src="static/images/kvartiri/Mitinskii-les/4-zal.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>ЖК Митинский лес</h4>
                            <p>бюджет 988.000₽</p>
                            <a href="static/images/kvartiri/Mitinskii-les/4-zal.jpg" title="Branding 2" data-gallery="portfolio-gallery-branding"
                               class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                            <a href="mitino1-details.html" title="More Details" class="details-link"><i
                                    class="bi bi-link-45deg"></i></a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                        <img src="static/images/kvartiri/Mitinskii-les/5-kuhnya.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>ЖК Митинский лес</h4>
                            <p>бюджет 988.000₽</p>
                            <a href="static/images/kvartiri/Mitinskii-les/5-kuhnya.jpg" title="App 3" data-gallery="portfolio-gallery-app"
                               class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                            <a href="mitino1-details.html" title="More Details" class="details-link"><i
                                    class="bi bi-link-45deg"></i></a>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                        <img src="static/images/kvartiri/Ilinskie-luga-kv9.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>ЖК Ильинские луга</h4>
                            <p>бюджет 800 тыс</p>
                            <a href="static/images/kvartiri/Ilinskie-luga-kv9.jpg" title="Branding 2" data-gallery="portfolio-gallery-branding"
                               class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                            <a href="mitino1-details.html" title="More Details" class="details-link"><i
                                    class="bi bi-link-45deg"></i></a>
                        </div>
